...
export async function loadExecutablePluginBundle(
  repoRoot,
  bundlePath = join(repoRoot, 'dist', 'subsonic.jsplugin.zip'),
) {
  ...
  // with the builder's JavaScript settings for behavior tests, while the
  // release-package contract continues to validate the actual .jsc artifact.
